		        ...
		        <div id="wrapper">
					<div id="content">
		       			<div id="box">
		                    ...
		                    <form id="form" action="${baseUrl}/pub_mgr.html" method="get" class="expose"> 
		                    	<fieldset id="personal">
									<legend>查询条件</legend>
									<select name="select-data" id="data"  onchange="mychange()">
		      							<option value="data-mgr" >数据管理</option>
		      							<option value="pub-mgr" selected="selected" >发布者管理</option>
		      							<option value="sub-mgr" >订阅者管理</option>
		      						</select>&nbsp;
									DataId : <input name="dataId" id="lastname" type="text" tabindex="1" size="60" value="${dataId}"/><br/>
			                        &nbsp;GroupId : <input name="groupId" id="firstname" type="text" tabindex="2" size="35" value="${groupId }"/>
			                        &nbsp;IP : <input name="hostId" id="hostId" type="text" tabindex="2" size="35" value="${hostId }"/>
		                    ...
		                    <%@include file="/page/common/publisher/publisherQueryResult.jsp"%>
		                </div>
					</div>
