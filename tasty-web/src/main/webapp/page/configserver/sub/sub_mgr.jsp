...
<body>
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				<div id="box">
					<form id="form" action="${baseUrl}/sub_mgr.html" method="get" class="expose">
						<fieldset id="personal">
							<legend>查询条件</legend>
							<select name="select-data" id="data" onchange="mychange()">
								<option value="data-mgr">数据管理</option>
								<option value="pub-mgr">发布者管理</option>
								<option value="sub-mgr" selected="selected">订阅者管理</option>
							</select>&nbsp; DataId : <input name="dataId" id="lastname" type="text" tabindex="1" size="60" value="${dataId}" /><br />
							&nbsp;GroupId : <input name="groupId" id="firstname" type="text" size="35" tabindex="2" value="${groupId }" />
							&nbsp;&nbsp;IP : <input name="hostId" id="hostId" type="text" size="35" tabindex="2" value="${hostId }" /> &nbsp;<input
								type="checkbox" name="like" <c:if test="${like}">checked="checked"</c:if> />模糊查找
						</fieldset>
						<div align="center">
					...
					<%@include file="/page/common/subscriber/subscriberQueryResult.jsp"%>

				</div>
			</div>
			<jsp:include page="/page/common/menu.jsp">
				<jsp:param name="select" value='sub_mgr' />
			</jsp:include>
